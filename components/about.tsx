          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <p className="text-lg text-foreground/80 leading-relaxed">
                ...
                of experience building scalable web applications and DevOps
                solutions. Currently working at Elanco as a Software Engineer, I
                focus on crafting efficient, maintainable code that makes a real
                impact.
              </p>

              <p className="text-lg text-foreground/80 leading-relaxed">
                My journey has taken me through cutting-edge technologies
                including React, Next.js, Node.js, and cloud platforms. I'm
                particularly enthusiastic about DevOps practices, CI/CD
