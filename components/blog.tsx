  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Exploring the latest features in Next.js 16 and how they improve application scalability and developer experience.",
      date: "Dec 15, 2024",
      readTime: "8 min read",
      category: "React",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to implementing CI/CD pipelines, containerization, and monitoring in your development workflow.",
      date: "Nov 28, 2024",
    ...
    },
    {
      ...
      excerpt:
        "Deep dive into advanced TypeScript features including conditional types, mapped types, and utility types.",
      date: "Nov 10, 2024",
    ...
    },
    {
      ...
      excerpt:
        "Real-world case study of performance optimization techniques that reduced load times by 70%.",
      date: "Oct 22, 2024",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Insights, tutorials, and thoughts on modern web development, DevOps,
